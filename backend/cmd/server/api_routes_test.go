...
func TestProtectedAPIRouteMatrixRejectsUnauthenticatedRequests(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodGet, "/api/assets/" + id},
		{http.MethodPut, "/api/assets/" + id},
		{http.MethodDelete, "/api/assets/" + id},
		{http.MethodPost, "/api/assets/" + id + "/move"},
		{http.MethodGet, "/api/assets/" + id + "/children"},
		{http.MethodGet, "/api/assets/" + id + "/tree"},
		{http.MethodGet, "/api/assets/" + id + "/ancestors"},
		{http.MethodGet, "/api/assets/" + id + "/bindings"},
		{http.MethodPut, "/api/assets/" + id + "/bindings"},
		{http.MethodGet, "/api/assets/" + id + "/measurements"},
		{http.MethodGet, "/api/assets/" + id + "/measurements/stream"},
		{http.MethodGet, "/api/assets/" + id + "/connectivity"},
		{http.MethodGet, "/api/tags/" + id + "/assets"},

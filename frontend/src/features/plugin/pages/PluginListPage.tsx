...
function PluginListPage() {
  ...
  return <VGatewayShell breadcrumb={<>Dashboard <span>/</span> <strong>Plugins</strong></>}>
    <div className="plugin-content">
      <section className="plugin-heading"><div><p className="plugin-eyebrow">Built-in extensions</p><h1>Plugins</h1><p>Manage installed capabilities without giving Plugins direct access to Devices or protocols.</p><Link to="/utilities/new">Configure utility mappings</Link></div><Link className="plugin-primary-link" to="/plugins/new/energy"><PlugZap size={18} /><span>New Energy instance</span></Link></section>
